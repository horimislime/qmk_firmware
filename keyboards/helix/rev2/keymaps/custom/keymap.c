...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  | CAPS |  FN  |   N  |   M  |   ,  |   .  |   /  | UP   |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust|BKSLSH| SLSH | WIN  | ALT  | CMD  |Space |Enter | CMD  |  [   |  ]   | Left |Right | Down |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      KC_DOWN, KC_RGHT,  KC_LEFT, KC_RBRC, KC_LBRC, KC_ENT, KC_SPC, KC_SPC,    KC_LCMD, KC_LALT, KC_LCMD, KC_SLSH, KC_BSLASH, MO(_ADJUST) \
      ),
    ...
    [_ADJUST] =  LAYOUT( \
        ...
        _______, _______, KC_RGHT,KC_UP,   KC_DOWN, KC_LEFT,                   AG_SWAP, _______,KC_BSPC, _______,  _______, _______, \
